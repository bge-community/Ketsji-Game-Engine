...
void EEVEE_create_game_shgroups(EEVEE_EffectsInfo *effects, EEVEE_TextureList *txl, struct DefaultTextureList *dtxl,
	DRWShadingGroup **bloom_resolve, DRWShadingGroup **dofResolve);
