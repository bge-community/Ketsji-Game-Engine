...
PyObject *BL_ArmatureActuator::pyattr_get_object(PyObjectPlus *self, const struct EXP_Attribute *attrdef)
{
...
int BL_ArmatureActuator::pyattr_set_object(PyObjectPlus *self, const struct EXP_Attribute *attrdef, PyObject *value)
{
	BL_ArmatureActuator* actuator = static_cast<BL_ArmatureActuator*>(self);
	KX_GameObject* &target = (attrdef->m_name == "target") ? actuator->m_gametarget : actuator->m_gamesubtarget;
...
PyObject *BL_ArmatureActuator::pyattr_get_constraint(PyObjectPlus *self, const struct EXP_Attribute *attrdef)
{
	BL_ArmatureActuator* actuator = static_cast<BL_ArmatureActuator*>(self);
