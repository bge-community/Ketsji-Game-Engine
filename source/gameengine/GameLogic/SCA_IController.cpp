...
PyObject *SCA_IController::pyattr_get_state(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
...
PyObject *SCA_IController::pyattr_get_sensors(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
...
PyObject *SCA_IController::pyattr_get_actuators(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	return (new CListWrapper(self_v,
	                         ((SCA_IController *)self_v)->GetProxy(),
	                         nullptr,
