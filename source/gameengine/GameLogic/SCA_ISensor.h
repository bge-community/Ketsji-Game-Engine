...
public:
	...
	// \param skippedticks Number of skipped ticks when doing pulsing.
	...
	void Suspend(); // Stop sensing for a while.
	bool IsSuspended(); // Is this sensor switched off?
	void Resume(); // Resume sensing.
	bool GetState(); // Get the state of the sensor: positive or negative
	bool GetPrevState(); // Get the previous state of the sensor: positive or negative
	int GetPosTicks(); // Get the number of ticks since the last positive pulse
	int GetNegTicks(); // Get the number of ticks since the last negative pulse
