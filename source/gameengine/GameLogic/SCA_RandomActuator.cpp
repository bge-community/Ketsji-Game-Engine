...
EXP_Attribute SCA_RandomActuator::Attributes[] = {
...
PyObject *SCA_RandomActuator::pyattr_get_seed(PyObjectPlus *self, const struct EXP_Attribute *attrdef)
{
	SCA_RandomActuator* act = static_cast<SCA_RandomActuator*>(self);
	return PyLong_FromLong(act->m_base->GetSeed());
}

int SCA_RandomActuator::pyattr_set_seed(PyObjectPlus *self, const struct EXP_Attribute *attrdef, PyObject *value)
{
	SCA_RandomActuator* act = static_cast<SCA_RandomActuator*>(self);
