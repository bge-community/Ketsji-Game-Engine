...
class SCA_RandomActuator : public SCA_IActuator
{
 ...
 public:
	...
	static PyObject *pyattr_get_seed(PyObjectPlus *self, const struct EXP_Attribute *attrdef);
	static int pyattr_set_seed(PyObjectPlus *self, const struct EXP_Attribute *attrdef, PyObject *value);
