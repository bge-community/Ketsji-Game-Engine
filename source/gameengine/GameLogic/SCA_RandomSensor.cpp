...
PyObject *SCA_RandomSensor::pyattr_get_seed(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	SCA_RandomSensor* self = static_cast<SCA_RandomSensor*>(self_v);
	return PyLong_FromLong(self->m_basegenerator->GetSeed());
}

int SCA_RandomSensor::pyattr_set_seed(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value)
{
	SCA_RandomSensor* self = static_cast<SCA_RandomSensor*>(self_v);
