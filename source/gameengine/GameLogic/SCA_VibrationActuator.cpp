...
PyObject *SCA_VibrationActuator::pyattr_get_isVibrating(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef)
{
...
PyObject *SCA_VibrationActuator::pyattr_get_hasVibration(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef)
{
	SCA_VibrationActuator *self = static_cast<SCA_VibrationActuator *>(self_v);
	SCA_JoystickManager *mgr = (SCA_JoystickManager *)self->GetLogicManager();
	DEV_Joystick *instance = mgr->GetJoystickDevice(self->m_joyindex);
