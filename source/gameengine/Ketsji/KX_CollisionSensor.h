...
public:
	...
	static PyObject *pyattr_get_object_hit(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject *pyattr_get_object_hit_list(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
