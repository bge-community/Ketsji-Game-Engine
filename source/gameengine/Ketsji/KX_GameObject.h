...
public:
	...
	static int			pyattr_set_name(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_parent(PyObjectPlus *self_v, const EXP_Attribute *attrdef);

	static PyObject*	pyattr_get_group_object(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_group_members(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_scene(PyObjectPlus *self_v, const EXP_Attribute *attrdef);

	static PyObject*	pyattr_get_life(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_mass(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_mass(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_is_suspend_dynamics(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_lin_vel_min(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_lin_vel_min(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_lin_vel_max(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_lin_vel_max(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_ang_vel_min(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_ang_vel_min(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_ang_vel_max(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_ang_vel_max(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_layer(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_layer(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	...
	static PyObject*	pyattr_get_culled(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_cullingBox(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_worldPosition(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_worldPosition(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_localPosition(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_localPosition(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_localInertia(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_localInertia(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_worldOrientation(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_worldOrientation(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_localOrientation(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_localOrientation(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_worldScaling(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_worldScaling(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_localScaling(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_localScaling(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_localTransform(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_localTransform(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_worldTransform(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_worldTransform(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_worldLinearVelocity(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_worldLinearVelocity(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_localLinearVelocity(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_localLinearVelocity(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_worldAngularVelocity(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_worldAngularVelocity(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_localAngularVelocity(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_localAngularVelocity(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	...
	static PyObject*	pyattr_get_timeOffset(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_timeOffset(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_state(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_state(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_meshes(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_batchGroup(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_children(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_children_recursive(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_attrDict(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_obcolor(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_obcolor(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_components(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_collisionCallbacks(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_collisionCallbacks(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_collisionGroup(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_collisionGroup(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_collisionMask(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_collisionMask(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_debug(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_debug(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_debugRecursive(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_debugRecursive(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_linearDamping(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_linearDamping(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_angularDamping(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_angularDamping(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);
	static PyObject*	pyattr_get_lodManager(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static int			pyattr_set_lodManager(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value);

	/* Experimental! */
	static PyObject*	pyattr_get_sensors(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
	static PyObject*	pyattr_get_controllers(PyObjectPlus *self_v, const EXP_Attribute *attrdef);
