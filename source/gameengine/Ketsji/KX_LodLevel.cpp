...
PyObject *KX_LodLevel::pyattr_get_use_hysteresis(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_LodLevel *self = static_cast<KX_LodLevel *>(self_v);
	return PyBool_FromLong(self->GetFlag() & KX_LodLevel::USE_HYSTERESIS);
}

PyObject *KX_LodLevel::pyattr_get_use_mesh(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_LodLevel *self = static_cast<KX_LodLevel *>(self_v);
	return PyBool_FromLong(self->GetFlag() & KX_LodLevel::USE_MESH);
}

PyObject *KX_LodLevel::pyattr_get_use_material(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_LodLevel *self = static_cast<KX_LodLevel *>(self_v);
