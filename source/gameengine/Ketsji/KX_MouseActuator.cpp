...
PyObject* KX_MouseActuator::pyattr_get_limit_x(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
...
int KX_MouseActuator::pyattr_set_limit_x(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value)
{
...
PyObject* KX_MouseActuator::pyattr_get_limit_y(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_MouseActuator* self= static_cast<KX_MouseActuator*>(self_v);
	return PyObjectFrom(MT_Vector2(self->m_limit_y[0] / (float)M_PI * 180.0f, self->m_limit_y[1] / (float)M_PI * 180.0f));
}

int KX_MouseActuator::pyattr_set_limit_y(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value)
{
	PyObject *item1, *item2;
	KX_MouseActuator* self= static_cast<KX_MouseActuator*>(self_v);
...
PyObject* KX_MouseActuator::pyattr_get_angle(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_MouseActuator* self= static_cast<KX_MouseActuator*>(self_v);
	return PyObjectFrom(MT_Vector2(self->m_angle[0] / (float)M_PI * 180.0f, self->m_angle[1] / (float)M_PI * 180.0f));
}

int KX_MouseActuator::pyattr_set_angle(PyObjectPlus *self_v, const EXP_Attribute *attrdef, PyObject *value)
{
	PyObject *item1, *item2;
	KX_MouseActuator* self= static_cast<KX_MouseActuator*>(self_v);
