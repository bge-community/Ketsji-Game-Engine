...
PyObject *KX_SCA_AddObjectActuator::pyattr_get_object(PyObjectPlus *self, const struct EXP_Attribute *attrdef)
{
...
int KX_SCA_AddObjectActuator::pyattr_set_object(PyObjectPlus *self, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_SCA_AddObjectActuator* actuator = static_cast<KX_SCA_AddObjectActuator*>(self);
...
PyObject *KX_SCA_AddObjectActuator::pyattr_get_objectLastCreated(PyObjectPlus *self, const struct EXP_Attribute *attrdef)
{
	KX_SCA_AddObjectActuator* actuator = static_cast<KX_SCA_AddObjectActuator*>(self);
