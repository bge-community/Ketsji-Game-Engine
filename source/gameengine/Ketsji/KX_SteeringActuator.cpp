...
EXP_Attribute KX_SteeringActuator::Attributes[] = {
...
int KX_SteeringActuator::pyattr_set_target(PyObjectPlus *self, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_SteeringActuator* actuator = static_cast<KX_SteeringActuator*>(self);
...
PyObject *KX_SteeringActuator::pyattr_get_navmesh(PyObjectPlus *self, const struct EXP_Attribute *attrdef)
{
	KX_SteeringActuator* actuator = static_cast<KX_SteeringActuator*>(self);
...
int KX_SteeringActuator::pyattr_set_navmesh(PyObjectPlus *self, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_SteeringActuator* actuator = static_cast<KX_SteeringActuator*>(self);
	KX_GameObject *gameobj;
...
PyObject *KX_SteeringActuator::pyattr_get_steeringVec(PyObjectPlus *self, const struct EXP_Attribute *attrdef)
{
	KX_SteeringActuator* actuator = static_cast<KX_SteeringActuator*>(self);
...
PyObject *KX_SteeringActuator::pyattr_get_path(PyObjectPlus *self, const struct EXP_Attribute *attrdef)
{
