...
PyObject *KX_TrackToActuator::pyattr_get_object(PyObjectPlus *self, const struct EXP_Attribute *attrdef)
{
...
int KX_TrackToActuator::pyattr_set_object(PyObjectPlus *self, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_TrackToActuator* actuator = static_cast<KX_TrackToActuator*>(self);
