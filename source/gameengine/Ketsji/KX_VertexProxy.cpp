...
PyObject *KX_VertexProxy::pyattr_get_y(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return PyFloat_FromDouble(self->m_vertex->getXYZ()[1]);
}

PyObject *KX_VertexProxy::pyattr_get_z(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return PyFloat_FromDouble(self->m_vertex->getXYZ()[2]);
}

PyObject *KX_VertexProxy::pyattr_get_r(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return PyFloat_FromDouble(self->m_vertex->getRGBA(0)[0] / 255.0);
}

PyObject *KX_VertexProxy::pyattr_get_g(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return PyFloat_FromDouble(self->m_vertex->getRGBA(0)[1] / 255.0);
}

PyObject *KX_VertexProxy::pyattr_get_b(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return PyFloat_FromDouble(self->m_vertex->getRGBA(0)[2] / 255.0);
}

PyObject *KX_VertexProxy::pyattr_get_a(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return PyFloat_FromDouble(self->m_vertex->getRGBA(0)[3] / 255.0);
}

PyObject *KX_VertexProxy::pyattr_get_u(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return PyFloat_FromDouble(self->m_vertex->getUV(0)[0]);
}

PyObject *KX_VertexProxy::pyattr_get_v(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return PyFloat_FromDouble(self->m_vertex->getUV(0)[1]);
}

PyObject *KX_VertexProxy::pyattr_get_u2(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return (self->m_vertex->getUvSize() > 1) ? PyFloat_FromDouble(self->m_vertex->getUV(1)[0]) : PyFloat_FromDouble(0.0f);
}

PyObject *KX_VertexProxy::pyattr_get_v2(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return (self->m_vertex->getUvSize() > 1) ? PyFloat_FromDouble(self->m_vertex->getUV(1)[1]) : PyFloat_FromDouble(0.0f);
}

PyObject *KX_VertexProxy::pyattr_get_XYZ(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return PyObjectFrom(MT_Vector3(self->m_vertex->getXYZ()));
}

PyObject *KX_VertexProxy::pyattr_get_UV(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
...
PyObject *KX_VertexProxy::pyattr_get_uvs(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
...
PyObject *KX_VertexProxy::pyattr_get_colors(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	return (new CListWrapper(self_v,
							 ((KX_VertexProxy *)self_v)->GetProxy(),
							 nullptr,
...
PyObject *KX_VertexProxy::pyattr_get_color(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
...
PyObject *KX_VertexProxy::pyattr_get_normal(PyObjectPlus *self_v, const EXP_Attribute *attrdef)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	return PyObjectFrom(MT_Vector3(self->m_vertex->getNormal()));
}

int KX_VertexProxy::pyattr_set_x(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
...
int KX_VertexProxy::pyattr_set_y(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PyFloat_Check(value)) {
		float val = PyFloat_AsDouble(value);
...
int KX_VertexProxy::pyattr_set_z(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PyFloat_Check(value)) {
		float val = PyFloat_AsDouble(value);
...
int KX_VertexProxy::pyattr_set_u(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PyFloat_Check(value)) {
		float val = PyFloat_AsDouble(value);
...
int KX_VertexProxy::pyattr_set_v(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PyFloat_Check(value)) {
		float val = PyFloat_AsDouble(value);
...
int KX_VertexProxy::pyattr_set_u2(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PyFloat_Check(value)) {
...
int KX_VertexProxy::pyattr_set_v2(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PyFloat_Check(value)) {
		if (self->GetVertex()->getUvSize() > 1) {
...
int KX_VertexProxy::pyattr_set_r(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PyFloat_Check(value)) {
		float val = PyFloat_AsDouble(value);
...
int KX_VertexProxy::pyattr_set_g(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PyFloat_Check(value)) {
		float val = PyFloat_AsDouble(value);
...
int KX_VertexProxy::pyattr_set_b(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PyFloat_Check(value)) {
		float val = PyFloat_AsDouble(value);
...
int KX_VertexProxy::pyattr_set_a(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PyFloat_Check(value)) {
		float val = PyFloat_AsDouble(value);
...
int KX_VertexProxy::pyattr_set_XYZ(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
...
int KX_VertexProxy::pyattr_set_UV(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PySequence_Check(value)) {
		MT_Vector2 vec;
...
int KX_VertexProxy::pyattr_set_uvs(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PySequence_Check(value)) {
		MT_Vector2 vec;
...
int KX_VertexProxy::pyattr_set_color(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PySequence_Check(value)) {
		MT_Vector4 vec;
...
int KX_VertexProxy::pyattr_set_colors(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PySequence_Check(value)) {
		MT_Vector4 vec;
...
int KX_VertexProxy::pyattr_set_normal(PyObjectPlus *self_v, const struct EXP_Attribute *attrdef, PyObject *value)
{
	KX_VertexProxy *self = static_cast<KX_VertexProxy *>(self_v);
	if (PySequence_Check(value)) {
		MT_Vector3 vec;
